...
const CreateDialog = (props) => {
  const { isOpen, handleClosed, title, bodyDialog, bodyDialog2 } = props;
  ...
  return (
    <Modal
      ...
      onCancel={onClose}
      footer={[
        <Button form="myForm" key="back" onClick={handleClosed}>
          Đóng
        </Button>,
      ]}
    >
      {loading ? (
        ...
        //               name="maKhachHang"
        //               rules={[
        //                 { required: true, message: "Nhập Mã Khách Hàng!" },
        //               ]}
        //             >
        //               <Input />
        //             </Form.Item>
        ...
        //               rules={[
        //                 { required: true, message: "Nhập Nhóm Khách Hàng!" },
        //               ]}
        //             >
        //               <Select allowClear>
        //                 {dataKH &&
