...
namespace Managerment.Migrations
{
    ...
    [Migration("20221129190144_update-goods-receipt-remove-cus")]
    partial class updategoodsreceiptremovecus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Managerment.GoodsReceiptProducts.GoodsReceiptProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("Goods_receipt_id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Goods_receipt_id");

                    b.HasIndex("Product_id");

                    b.ToTable("AppGoodsReceiptProducts", (string)null);
                });
            ...
            modelBuilder.Entity("Managerment.ProcessWarranties.ProcessWarranty", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("Order_warranty_id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("User_warranty")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("Warranty_date")
                        .HasColumnType("datetime2");

                    b.Property<decimal>("Warranty_price")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("Warranty_process")
                        .HasColumnType("int");

                    b.Property<string>("Warranty_status")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.HasIndex("Order_warranty_id");

                    b.ToTable("AppProcessWarranties", (string)null);
                });
            ...
            modelBuilder.Entity("Managerment.ProductWarranties.ProductWarranty", b =>
                {
                    ...
                    b.Property<Guid>("ID_order_warranty")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("Product_warranty_type")
                        .HasColumnType("int");

                    b.Property<int>("Total_count")
                        .HasColumnType("int");

                    b.Property<int>("Warranty_times")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Managerment.GoodsReceiptProducts.GoodsReceiptProduct", b =>
                {
                    b.HasOne("Managerment.GoodsReceipts.GoodsReceipt", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Managerment.ProcessWarranties.ProcessWarranty", b =>
                {
                    b.HasOne("Managerment.OrderWarranties.OrderWarranty", null)
                        .WithMany()
                        .HasForeignKey("Order_warranty_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Managerment.ProductWarranties.ProductWarranty", b =>
                {
                    ...
                    b.HasOne("Managerment.OrderWarranties.OrderWarranty", null)
                        .WithMany()
                        .HasForeignKey("ID_order_warranty")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
