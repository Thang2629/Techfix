...
namespace Managerment.Controllers
{
    ...
    public class ProcessRepairController : ManagermentController
    {
        ...
        [HttpGet("group-customer-order-process_repairs")]
        public async Task<ReponseDataDto<GroupProcessRepairDto>> GetGroupCustomerProcessRepair(int page, int perPage, string filter = null, DateTime? fromDate = null,
                      DateTime? toDate = null, ECustomerTypeEnum? customerTypeEnum = null, EProcessRepairType? eProcessRepairType = null, Guid? user_id = null)
        {
            return await _orderRepairAppService.GetGroupCustomerProcessRepair(page, perPage, filter, fromDate, toDate, customerTypeEnum, eProcessRepairType, user_id);
        }

        [HttpGet("group-user-order-process_repairs")]
        public async Task<ReponseDataDto<GroupProcessRepairDto>> GetGroupUserProcessRepair(int page, int perPage, string filter = null, DateTime? fromDate = null,
              DateTime? toDate = null, ECustomerTypeEnum? customerTypeEnum = null, EProcessRepairType? eProcessRepairType = null, Guid? user_id = null)
        {
            return await _orderRepairAppService.GetGroupUserProcessRepair(page, perPage, filter, fromDate, toDate, customerTypeEnum, eProcessRepairType, user_id);
        }
        /// <summary>
        ...
        /// <returns></returns>
        [HttpPut]
        public async Task UpdateProcessRepair(Guid process_repair_id, Guid product_repair_id, Guid order_repair_id, [FromBody]UpdateProcessProductRepairDto updateProcessProductRepairDto)
        {
