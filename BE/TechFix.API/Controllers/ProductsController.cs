...
namespace TechFix.API.Controllers
{
    ...
    public class ProductsController : CustomController
    {
        ...
        public ProductsController(IMapper mapper, IOptions<AppSettings> appSettings, DataContext context, IWebHostEnvironment env, IHelperService helperService, CommonService commonService) : base(mapper, appSettings, context, env, commonService)
        {
