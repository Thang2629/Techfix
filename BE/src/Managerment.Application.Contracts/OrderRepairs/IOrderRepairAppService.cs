...
namespace Managerment.OrderRepairs
{
    public interface IOrderRepairAppService : IApplicationService
    {
        ...
        Task<ReponseDataDto<GroupProcessRepairDto>> GetGroupCustomerProcessRepair(int page, int perPage, string filter = null, DateTime? fromDate = null,
                         DateTime? toDate = null, ECustomerTypeEnum? customerTypeEnum = null, EProcessRepairType? eProcessRepairType = null, Guid? user_id = null);
        Task<ReponseDataDto<GroupProcessRepairDto>> GetGroupUserProcessRepair(int page, int perPage, string filter = null, DateTime? fromDate = null,
                 DateTime? toDate = null, ECustomerTypeEnum? customerTypeEnum = null, EProcessRepairType? eProcessRepairType = null, Guid? user_id = null);
